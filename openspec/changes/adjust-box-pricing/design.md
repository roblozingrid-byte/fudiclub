...
The current business specification sets the one-time Fudi Club box price hypothesis at $45,000 ARS containing 10-12 packaged items. While this established a strong initial positioning, lowering the price point to between $35,000 and $39,000 ARS will make the subscription box significantly more accessible for monthly self-gifting and impulse purchases.

To achieve this price reduction while maintaining our required gross margin (targeting ≥40% before shipping, with a strict 35% floor), we analyzed our unit economics and volumetric packing efficiency. We validated that adopting a flexible product range of 6 to 10 items per box (with 10 as the maximum) allows us to deliver an abundant mystery box experience (such as our inaugural 10-item edition achieving a >53% margin at $35,000 ARS) while protecting margins against wholesale inflation. We standardized physical packaging around an efficient 23x21.5x9cm corrugated box that accommodates this 6-10 item range perfectly without void space or product crushing.
...
**Non-Goals:**
- Changing shipping fee structures, carrier assignments, or delivery zones.
- Changing the core mystery box concept, local-to-imported product ratios, or brand color systems.

## Decisions

### 1. Flexible Product Count Range (6 to 10 items)
- **Decision:** Standardize the box contents to a flexible range of between 6 and 10 curated items per edition (with 10 as the maximum).
- **Rationale:** Through BMad financial analysis, we confirmed that committing to a fixed number (like 10 items always) creates inflation and margin risk when importing premium treats. By adopting a range of 6 to 10 items, Fudi Club can include larger, higher-value items in some months (6-7 items) or a broader variety of snacks in others (8-10 items like our inaugural edition costing ~$13,368 ARS), while consistently maintaining a >50% gross margin at the $35,000 ARS price point. This aligns with global mystery box best practices.
